    ...
    <div className="pt-20 pb-16 bg-black">
       <div className="w-[80%] mx-auto grid grid-cols-1 xl:grid-cols-3 items-center gap-20">
         ...
         <div className="flex items-center space-x-4"> 
            ...
            {/* title */}
            <h1 className="text-2xl md:text-3xl lg:text-[2.7rem] mt-8 font-bold md:leading-[3rem] lg:leading-[3.3rem] xl:leading-[3.6rem] text-white">Trusted by genius people.</h1>
            {/* discription */}
            <p className="text-base text-white text-opacity-50 mt-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus  </p>
            {/* info */}
